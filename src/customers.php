...
<body style="background-image: url(images/10.jpg)">
<?php
    include 'index.php';
...
<div class="container">
    <h2 class="text-center pt-4" style="color : black;"> <b><u> Our Customers </u></b> </h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #00b8e6; width : 100%">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
