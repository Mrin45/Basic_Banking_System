    ...
    else if($amount > $sql1['balance']) 
    {
        ...
        echo '</script>';
         ...
         echo "</script>";
                ...
                if($query){
                     echo "<script> alert('Done! Transaction is Successful.');
...
<body style="background-color : #74CFDF ;">
 

	<div class="container">
            <h2 class="text-center pt-4" style="color : black;"> <b><u>Easy Money Transfer</u></b></h2>
            <?php
                include 'index.php';
                $sid=$_GET['id'];
